...
10. **Project files:** You can attach any kind of file to a project. For example, you can attach guidelines, policies, good practices, etc. These files are available to you and those collaborating with you on the project. See "[Project files](project-files.md)" for the full walkthrough.
11. **Edit**: Click on the "Edit" button to [edit](projects.md#edit-a-project) the details of the project. For example, to change its description or its abstract.
12. **Delete**: Click on the "Delete" button to [delete](projects.md#delete-a-project) the project. <mark style="color:red;">**Note: When you delete a project you will delete all its forms and submissions**</mark>**.** Deleting a project will create a log in the platform for auditing purposes.
